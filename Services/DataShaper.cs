...
namespace Services
{
    public class DataShaper<T> : IDataShaper<T> where T : class
    {
        ...
        public IEnumerable<ExpandoObject> ShapeData(IEnumerable<T> entities, string fieldsString) // nesne koleksiyonundan veri şekillendirme
        {
            var requiredFields = GetRequiredProperties(fieldsString);
            return FetchData(entities, requiredFields);
        }

        public ExpandoObject ShapeData(T entity, string fieldsString)// bir nesneden veri şekillendirme
        {
            ...
            IEnumerable<PropertyInfo> requiredProperties)
        {
            ...
            foreach (var property in requiredProperties)
            {
                ...
                shapedObject.TryAdd(property.Name, objectPropertiyValue);
            }
            return shapedObject;
        }
