...
namespace Services
{
    public class DataShaper<T> : IDataShaper<T> where T : class
    {
        ...
        public IEnumerable<ShapedEntity> ShapeData(IEnumerable<T> entities, string fieldsString) // nesne koleksiyonundan veri şekillendirme
        {
            var requiredFields = GetRequiredProperties(fieldsString);
            return FetchData(entities, requiredFields);
        }

        public ShapedEntity ShapeData(T entity, string fieldsString)// bir nesneden veri şekillendirme
        {
            ...
            IEnumerable<PropertyInfo> requiredProperties)
        {
            ...
            {
                var objectPropertiyValue = property.GetValue(entity);
                shapedObject.Entity.TryAdd(property.Name, objectPropertiyValue);
            }
