...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        public async Task<TokenDto> RefreshToken(TokenDto tokenDto)
        {
            ...
            // böyle bir kullanıcı hala var mı ?
            ...
            {
                throw new RefreshTokenBadRequetException();
            }
        ...
        private ClaimsPrincipal GetPrincipalFromExpiredToken(string token)
        {
            ...
            var principal = tokenHandler.ValidateToken(token, tokenValidationParametes, out securityToken); // doğrulama işleminden kullanıcı bilgilerini alıyoruz.
            ...
            return principal;
        } // gelen token üzerinden kullanıcı bilgiler elimizde oluyor.
